...
void Fun4All_FillChargesMap_pp(  const int nEvents = 10, const int eventsInFileStart = 0, const string &fname = "/sphenix/sim/sim01/sphnxpro/Micromegas/2/G4Hits_sHijing_0-12fm_000000_001000.root", const string &foutputname = "/sphenix/user/shulga/Work/IBF/DistortionMap/Files/slim_G4Hits_sHijing_0-12fm_000000_001000.root" )
{
  ///////////////////////////////////////////
  // Make the Server
  //////////////////////////////////////////
